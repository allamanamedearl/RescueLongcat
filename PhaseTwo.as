package  {
	...
	public class PhaseTwo extends MovieClip {
		...
		//Constructor
		public function PhaseTwo(_stage:Stage){
		...
		private function SpawnEnemy():void {
			if(!isBossFight) {
				...
				if(boss_st >= BOSS_SPAWN) {
					var enemy:EnemySprite = new EnemySprite(StageVar, bossType); //2 - Phase two boss
					StageVar.addChild(enemy.image);
					enemyArr.push(enemy); 
					boss_st = 0;
					isBossFight = true;
